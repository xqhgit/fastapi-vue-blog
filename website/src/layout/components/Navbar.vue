<template>
  <div class="my-navbar">
    <b-navbar
      ...
      <b-navbar-brand href="/index">开源博客</b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item-dropdown right>
            ...
            <b-dropdown-item :to="{name: 'manage-posts'}">文章</b-dropdown-item>
            <b-dropdown-item :to="{name: 'manage-categories'}">分类</b-dropdown-item>
...
.my-navbar >>> .navbar-light .navbar-nav .nav-link.active {
  color: #777;
}
